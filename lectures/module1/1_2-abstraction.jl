...
Now, I want to do something to a collection of ones, that doesn't care about which one I'm using. So I'm going to write a function that takes in my collection, and add an image whereever I desire.
"""
...
begin
	oneimage = load(download("https://clipartsign.com/upload/2016/06/25/cute-number-one-clipart-image.png"))
	ONE = load(download("https://s3-eu-west-1.amazonaws.com/oneworld-wp/app/uploads/2017/09/05162351/ONE.jpg"))
	nothing
end
...
begin
	one_keys = ["1", "1.0", "one", "1//1", "Cute One", "2x2 Identity", "ONE"] 
...
begin
	...
	insert(ONE, one_image_array, i, j)
end
